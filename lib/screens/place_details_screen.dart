            ...
            child: Container(
              ...
              child: _isFavoriteLoading
                  ...
                  : Icon(
                      ...
                      color: _isFavorite ? AppTheme.peach : Colors.white,
                      size: 20,
                    ),
            ),
          ),
                  ...
                  Row(
                    children: [
                      ...List.generate(
                        5,
                        (i) => Icon(
                          i < widget.place.averageRating.round()
                              ? Icons.star_rounded
                      ...
                      Text(
                        '${widget.place.averageRating.toStringAsFixed(1)}/5',
                        style: GoogleFonts.poppins(
                          fontSize: 13,
                          color: Colors.white,
                  ...
                  children: [
                    ...
                    if (widget.place.imageUrls.length > 3)
                      Container(
                        ...
                        child: Center(
                          child: Text(
                            '+${widget.place.imageUrls.length - 3}',
                            style: GoogleFonts.poppins(
                              fontSize: 11,
                              color: Colors.white,
      ...
      child: Row(
        children: [
          ...
          _StatChip(
            ...
            label: 'Rating',
            value: '${place.averageRating.toStringAsFixed(1)}/5',
          ),
          _StatDivider(),
          _StatChip(
            ...
            label: 'Budget',
            value: place.budget.isNotEmpty ? place.budget : 'Free',
          ),
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: place.recommendedDish
                .split(',')
                .map(
                  (d) => Container(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot>(
      stream: FirebaseFirestore.instance
          ...
          .doc(currentUserId)
          .snapshots(),
      builder: (_, snap) => _HelpfulPill(
        isActive: snap.data?.exists ?? false,
        count: count,
        onTap: onTap,
      ),
    );

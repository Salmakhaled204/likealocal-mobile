...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void _search(String q) {
    _ctrl.text = q;
    context.read<SearchProvider>().setSearchQuery(q);
    _focus.unfocus();
  }

  void _goToDetails(Place place) => Navigator.push(
    context,
                ...
                Row(
                  children: [
                    ...
                    Consumer<SearchProvider>(
                      builder: (_, sp, _) {
                        final has =
                            sp.selectedCategories.isNotEmpty ||
                            sp.userPreferences.isNotEmpty;
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              ...
                              children: [
                                Icon(
                                  Icons.tune_rounded,
                                  color: has ? AppTheme.primary : Colors.white,
                                  size: 22,
                                ),
                                if (has)
                                  Positioned(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text(
                            '${sp.searchResults.length} places found',
                            style: GoogleFonts.poppins(
                              fontSize: 13,
                              color: AppTheme.textLight,
                            ),
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (_, i) => PlaceCard(
                          place: sp.searchResults[i],
                          onTap: () => _goToDetails(sp.searchResults[i]),
                        ),
                      ),
                    ),
                  ],
          ...
          GridView.count(
            ...
            children: [
              _CatCard(
                ...
                onTap: () => onTagTap('Restaurants'),
              ),
              _CatCard(
                label: 'Cafes',
                icon: Icons.local_cafe_rounded,
                color: AppTheme.primary,
                onTap: () => onTagTap('Cafes'),
              ),
              _CatCard(
                label: 'Hidden Gems',
                icon: Icons.explore_rounded,
                color: AppTheme.accent,
                onTap: () => onTagTap('Hidden Gems'),
              ),
              _CatCard(
                label: 'Culture',
                icon: Icons.museum_rounded,
                color: AppTheme.softBlue,
                onTap: () => onTagTap('Culture'),
              ),
              _CatCard(
                label: 'Nightlife',
                icon: Icons.nightlife_rounded,
                color: AppTheme.peach,
                onTap: () => onTagTap('Nightlife'),
              ),
              _CatCard(
                label: 'Shopping',
                icon: Icons.shopping_bag_rounded,
                color: AppTheme.primary,
                onTap: () => onTagTap('Shopping'),
              ),
            ],
          ),
        ],
